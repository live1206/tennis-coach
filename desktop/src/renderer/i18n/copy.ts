...
export const COPY: Record<Language, Copy> = {
  en: {
    ...
    welcome: {
      eyebrow: 'Local-first tennis video intelligence',
      description: 'Turn tennis video into evidence-backed coaching insights and highlight reels. Raw video stays on your device while deterministic audio, vision, ball, pose, and player analysis produces reviewable data.',
      startLabel: 'Start',
      importTitle: 'Import videos',
      importDetail: 'Choose one or more match or practice videos to extract rally highlights.',
    ...
    aiAnalysis: {
      ...
      qualityWarnings: 'Mandatory limitations',
    ...
    analysisPanel: {
      ...
      intro: 'After a new video is imported, Tennis Coach reads the full match and filters it into highlight candidates worth keeping.',
  ...
  zh: {
    ...
    welcome: {
      eyebrow: '本地优先的网球视频智能分析',
      description: '将网球视频转化为有证据支持的训练建议和精彩集锦。原始视频保留在本机，音频、视觉、球路、姿态和球员分析生成可核查的数据。',
      startLabel: '开始',
      importTitle: '导入多个视频',
      importDetail: '选择一个或多个比赛/训练视频，提取回合和精彩片段。',
    ...
    analysisPanel: {
      ...
      autoStart: '自动开始',
      headline: '正在用 AI\n分析整场视频',
      intro: '新视频导入后会自动开始处理。Tennis Coach 会先读取整场比赛，再逐段筛选值得保留的精彩瞬间。',
      cancel: '取消处理',
