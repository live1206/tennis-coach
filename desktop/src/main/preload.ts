...
contextBridge.exposeInMainWorld('api', {
  ...
  runCloudAIAnalysis: (
    ...
    question: string,
    modelAlias: string,
  ) => ipcRenderer.invoke('run-cloud-ai-analysis', videoPath, evidenceId, question, modelAlias),
  cancelLocalAIAnalysis: () => ipcRenderer.invoke('cancel-local-ai-analysis') as Promise<void>,
  cancelAIAnalysis: () => ipcRenderer.invoke('cancel-ai-analysis') as Promise<void>,
