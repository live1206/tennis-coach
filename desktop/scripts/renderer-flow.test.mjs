...
assert.match(mainSource, /ipcMain\.handle\('open-analysis-dialog'/)
...
assert.match(preloadSource, /openAnalysisDialog/)
assert.match(preloadSource, /runLocalAIAnalysis/)
assert.match(preloadSource, /cancelLocalAIAnalysis/)
assert.match(typesSource, /loadAnalysisJson/)
assert.match(welcomeSource, /copy\.welcome\.aiAnalysisTitle/)
